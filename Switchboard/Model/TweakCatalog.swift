...
enum TweakCatalog {
    ...
    static let everyday: [Tweak] = [
        ...
        Tweak(id: "everyday.window-snapping", title: "Snap windows",
              subtitle: "Control-Option-arrows, or hold Control while dragging",
              category: .everyday, symbol: "rectangle.split.2x1",
              control: .toggle, behavior: .windowSnapping),
        Tweak(id: "everyday.window-switching", title: "Window switcher",
              subtitle: "Replace Command-Tab with previews of individual windows",
              category: .everyday, symbol: "rectangle.on.rectangle",
              control: .toggle, behavior: .windowSwitching),
